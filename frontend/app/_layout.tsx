...
import { PostAuthTermsGuard } from "../components/ui/PostAuthTermsGuard";
        ...
        <ThemeProvider>
          <I18nProvider>
            <AuthProvider>
              <DemoProvider>
                <ThemedStack />
                {/* Global post-auth gate: shows T&C only AFTER signup/login
                   if the user hasn't accepted the current version yet.
